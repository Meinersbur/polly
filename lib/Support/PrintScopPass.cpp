...
RegionPass *polly::createAnalyzeScopPass() {
	return new AnalyzeScop();
}

INITIALIZE_PASS_BEGIN(PrintScop, "polly-print-scop", "Polly - Print SCoP",                      false, false)
INITIALIZE_PASS_DEPENDENCY(ScopInfoRegionPass)
INITIALIZE_PASS_END(PrintScop, "polly-print-scop", "Polly - Print SCoP", false,                    false)

	INITIALIZE_PASS_BEGIN(AnalyzeScop, "polly-analyze-scop", "Polly - Analyze SCoP",		false, false)
	INITIALIZE_PASS_DEPENDENCY(ScopInfoRegionPass)
	INITIALIZE_PASS_END(AnalyzeScop, "polly-analyze-scop", "Polly - Analyze SCoP", false,false)
