...
static bool CodeGen(Scop &S, IslAstInfo &AI, LoopInfo &LI, DominatorTree &DT,
  ...
  // We modified code around the SCoP and therefore the previous analysis is not reliable anymore. This includes e.g. invoking -polly-codegen a second time.
  S.markAsToBeSkipped();
...
public:
  ...
  bool runOnScop(Scop &S) override {
    // Skip SCoPs in case they're already code-generated by CodeGen or PPCGCodeGeneration.
	  if (S.isToBeSkipped()) {
