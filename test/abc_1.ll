...
; Derived from C:\Users\Meinersbur/src/llvm/tools/polly/test\abc_0.ll
; Original command: clang -mllvm -enable-newgvn -mllvm -polly -O3 abc.c -c

; ModuleID = 'C:\Users\MEINER~1\AppData\Local\Temp\reproduce-ooagxfei\bugpoint-reduced-simplified.bc'
