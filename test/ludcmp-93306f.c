...
int main(int argc, char** argv)
{
  ...
  double (*x_StrictFP)[1024 +1 + 0]; x_StrictFP = (double(*)[1024 +1 + 0])polybench_alloc_data (1024 +1 + 0, sizeof(double));;
   ...
   *x_StrictFP,
   *y);
  if (!check_FP(n, *x, *x_StrictFP))
    return 1;



  print_array(n, *x_StrictFP);


  free((void*)A);;
  free((void*)b);;
  free((void*)x);;
  free((void*)x_StrictFP);;
  free((void*)y);;
