...
; CHECK-NEXT:     Lifetime: { [MemRef_global_data[31999] -> [i1, i2{{\]\]}} -> Val_1_000000e_00[] : i1 >= 2; [MemRef_global_data[31999] -> [1, i2{{\]\]}} -> Val_1_000000e_00[] : i2 > 0; [MemRef_global_data[i0] -> [i1, i2{{\]\]}} -> Undef[] : i1 < 0 and 0 <= floor((i0)/10) <= 3199 and 10*floor((i0)/10) <= -4 + i0; [MemRef_global_data[32004] -> [i1, i2{{\]\]}} -> Undef[]; [MemRef_global_data[31999] -> [i1, i2{{\]\]}} -> Undef[] : i1 <= 0; [MemRef_global_data[i0] -> [0, i2{{\]\]}} -> Undef[] : floor((i0)/10) >= i2 and 0 <= floor((i0)/10) <= 3199 and 10*floor((i0)/10) <= -4 + i0; [MemRef_global_data[31999] -> [1, i2{{\]\]}} -> Undef[] : i2 <= 0; [MemRef_global_data[i0] -> [i1, i2{{\]\]}} -> Val__000000e_00[] : i1 > 0 and 0 <= floor((i0)/10) <= 3199 and 9*floor((i0)/10) >= -3207 + i0 and 10*floor((i0)/10) <= -4 + i0; [MemRef_global_data[i0] -> [0, i2{{\]\]}} -> Val__000000e_00[] : 0 <= floor((i0)/10) <= 3199 and floor((i0)/10) < i2 and 9*floor((i0)/10) >= -3207 + i0 and 10*floor((i0)/10) <= -4 + i0 } + Unknown
...
; CHECK-NEXT:     Stmt_for_body28_i943
; CHECK-NEXT:             MustWriteAccess :=    [Reduction Type: NONE] [Scalar: 0]
; CHECK-NEXT:                 { Stmt_for_body28_i943[i0] -> MemRef_global_data[4 + 10i0] };
; CHECK-NEXT:             MustWriteAccess :=    [Reduction Type: NONE] [Scalar: 0]
; CHECK-NEXT:                 { Stmt_for_body28_i943[i0] -> MemRef_global_data[5 + 10i0] };
; CHECK-NEXT:             MustWriteAccess :=    [Reduction Type: NONE] [Scalar: 0]
; CHECK-NEXT:                 { Stmt_for_body28_i943[i0] -> MemRef_global_data[6 + 10i0] };
; CHECK-NEXT:             MustWriteAccess :=    [Reduction Type: NONE] [Scalar: 0]
; CHECK-NEXT:                 { Stmt_for_body28_i943[i0] -> MemRef_global_data[7 + 10i0] };
; CHECK-NEXT:             MustWriteAccess :=    [Reduction Type: NONE] [Scalar: 0]
; CHECK-NEXT:                 { Stmt_for_body28_i943[i0] -> MemRef_global_data[8 + 10i0] };
; CHECK-NEXT:             MustWriteAccess :=    [Reduction Type: NONE] [Scalar: 0]
; CHECK-NEXT:                 { Stmt_for_body28_i943[i0] -> MemRef_global_data[9 + 10i0] };
; CHECK-NEXT:     Stmt_for_body_i935
; CHECK-NEXT:             MustWriteAccess :=    [Reduction Type: NONE] [Scalar: 0]
; CHECK-NEXT:                 { Stmt_for_body_i935[] -> MemRef_global_data[32004] };
; CHECK-NEXT:             MustWriteAccess :=    [Reduction Type: NONE] [Scalar: 0]
; CHECK-NEXT:                 { Stmt_for_body_i935[] -> MemRef_global_data[31999] };
; CHECK-NEXT: }
