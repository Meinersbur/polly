...
; CHECK-NEXT:     Scalar access Stmt_nk_for_nk_exit_crit_edge MK_PHI Merge MemRef_beta_c_alpha_a_b_lcssa__phi as %beta_c_alpha_a_b.lcssa [new: [nj, nk, ni] -> { Stmt_nk_for_nk_exit_crit_edge[i0, i1] -> MemRef_C[i0, i1] : nk > 0 and 0 <= i0 < ni and 0 <= i1 < nj; Stmt_nk_for_nk_exit_crit_edge[0, i1] -> MemRef_C[0, i1] : nk > 0 and ni <= 0 and 0 <= i1 < nj }]:
