...
; CHECK-NEXT:     }
; CHECK-NEXT:     Mapping of double MemRef_beta_c_alpha_a_b3__phi MK_PHI {
; CHECK-NEXT:         Primary:   Stmt_nk_alpha MK_PHI Merge MemRef_beta_c_alpha_a_b3__phi as %beta_c_alpha_a_b3 [new: [nj, nk, ni] -> { Stmt_nk_alpha[i0, i1, i2] -> MemRef_C[i0, i1] : 0 <= i0 < ni and 0 <= i1 < nj and 0 <= i2 < nk; Stmt_nk_alpha[0, i1, i2] -> MemRef_C[0, i1] : ni <= 0 and 0 <= i1 < nj and 0 <= i2 < nk }]
; CHECK-NEXT:         Secondary: Stmt_nk_alpha_lr_ph MK_PHI Incoming MemRef_beta_c_alpha_a_b3__phi value %c_idx_ij.promoted [new: [nj, nk, ni] -> { Stmt_nk_alpha_lr_ph[i0, i1] -> MemRef_C[i0, i1] : nk > 0 and 0 <= i0 < ni and 0 <= i1 < nj; Stmt_nk_alpha_lr_ph[0, i1] -> MemRef_C[0, i1] : nk > 0 and ni <= 0 and 0 <= i1 < nj }]
; CHECK-NEXT:         Secondary: Stmt_nk_inc MK_PHI Incoming MemRef_beta_c_alpha_a_b3__phi value %beta_c_alpha_a_b [new: [nj, nk, ni] -> { Stmt_nk_inc[i0, i1, i2] -> MemRef_C[i0, i1] : 0 <= i0 < ni and 0 <= i1 < nj and 0 <= i2 < nk; Stmt_nk_inc[0, i1, i2] -> MemRef_C[0, i1] : ni <= 0 and 0 <= i1 < nj and 0 <= i2 < nk }]
; CHECK-NEXT:         Target:    [nj, nk, ni] -> { Stmt_nk_alpha[i0, i1, i2] -> MemRef_C[i0, i1] : 0 <= i0 < ni and 0 <= i1 < nj and 0 <= i2 < nk; Stmt_nk_alpha[0, i1, i2] -> MemRef_C[0, i1] : ni <= 0 and 0 <= i1 < nj and 0 <= i2 < nk }
...
; CHECK-NEXT:             Written : [nj, nk, ni] -> { [MemRef_C[i0, i1] -> [i0, i1, 1, 0, 0{{\]\]}} -> [Stmt_nk_alpha_lr_ph[i0, i1] -> Val_c_idx_ij_promoted[{{\]\]}} : nk > 0 and 0 <= i0 < ni and 0 <= i1 < nj; [MemRef_C[0, i1] -> [0, i1, 1, 0, 0{{\]\]}} -> [Stmt_nk_alpha_lr_ph[0, i1] -> Val_c_idx_ij_promoted[{{\]\]}} : nk > 0 and ni <= 0 and 0 <= i1 < nj; [MemRef_C[i0, i1] -> [i0, i1, 2, i5, 1{{\]\]}} -> [Stmt_nk_alpha[i0, i1, i5] -> Val_beta_c_alpha_a_b[{{\]\]}} : 0 <= i0 < ni and 0 <= i1 < nj and 0 <= i5 < nk; [MemRef_C[0, i1] -> [0, i1, 2, i5, 1{{\]\]}} -> [Stmt_nk_alpha[0, i1, i5] -> Val_beta_c_alpha_a_b[{{\]\]}} : ni <= 0 and 0 <= i1 < nj and 0 <= i5 < nk }
; CHECK-NEXT:     }
; CHECK-NEXT: }
...
; CHECK-NEXT:     Written : [nj, nk, ni] -> { [MemRef_C[i0, i1] -> [i0, i1, 3, 0, 0{{\]\]}} -> [Stmt_nk_for_nk_exit_crit_edge[i0, i1] -> Val_beta_c_alpha_a_b_lcssa[{{\]\]}} : nk > 0 and 0 <= i0 < ni and 0 <= i1 < nj; [MemRef_C[0, i1] -> [0, i1, 3, 0, 0{{\]\]}} -> [Stmt_nk_for_nk_exit_crit_edge[0, i1] -> Val_beta_c_alpha_a_b_lcssa[{{\]\]}} : nk > 0 and ni <= 0 and 0 <= i1 < nj; [MemRef_C[i0, i1] -> [i0, i1, 2, i5, 1{{\]\]}} -> [Stmt_nk_alpha[i0, i1, i5] -> Val_beta_c_alpha_a_b[{{\]\]}} : 0 <= i0 < ni and 0 <= i1 < nj and 0 <= i5 < nk; [MemRef_C[0, i1] -> [0, i1, 2, i5, 0{{\]\]}} -> [Stmt_nk_alpha[0, i1, i5] -> Val_beta_c_alpha_a_b[{{\]\]}} : ni <= 0 and 0 <= i1 < nj and 0 <= i5 < nk; [MemRef_C[i0, i1] -> [i0, i1, 2, i5, 0{{\]\]}} -> [Stmt_nk_alpha[i0, i1, i5] -> Val_beta_c_alpha_a_b[{{\]\]}} : 0 <= i0 < ni and 0 <= i1 < nj and 0 <= i5 < nk; [MemRef_C[0, i1] -> [0, i1, 2, i5, 1{{\]\]}} -> [Stmt_nk_alpha[0, i1, i5] -> Val_beta_c_alpha_a_b[{{\]\]}} : ni <= 0 and 0 <= i1 < nj and 0 <= i5 < nk; [MemRef_C[i0, i1] -> [i0, i1, 0, 0, 0{{\]\]}} -> [Stmt_nj_beta[i0, i1] -> Val_c_beta[{{\]\]}} : 0 <= i0 < ni and 0 <= i1 < nj; [MemRef_C[0, i1] -> [0, i1, 0, 0, 0{{\]\]}} -> [Stmt_nj_beta[0, i1] -> Val_c_beta[{{\]\]}} : ni <= 0 and 0 <= i1 < nj; [MemRef_C[i0, i1] -> [i0, i1, 1, 0, 0{{\]\]}} -> [Stmt_nk_alpha_lr_ph[i0, i1] -> Val_c_idx_ij_promoted[{{\]\]}} : nk > 0 and 0 <= i0 < ni and 0 <= i1 < nj; [MemRef_C[0, i1] -> [0, i1, 1, 0, 0{{\]\]}} -> [Stmt_nk_alpha_lr_ph[0, i1] -> Val_c_idx_ij_promoted[{{\]\]}} : nk > 0 and ni <= 0 and 0 <= i1 < nj }
; CHECK-NEXT: }
